...
# Solution 1
# for i in products:
#     if i.get('price') > 25.00:
#         print(i.get('name'))
# Solution 2
# for i in products:
#     if i.get('is_on_sale'):
#         print(f"{i.get('name')} are on sale for {i.get('sale_price')}")

# Solution 3
for i in products:
    if i.get('is_on_sale') and (i.get('sale_price') is None):
        print(f"{i.get('name')} are on sale but do not have a sale price")

# Solution 3 in different way
no_sale_price_list = []
for i in products:
